...
/* package SATSolver-0.1.0.0 */
#ifndef VERSION_SATSolver
#define VERSION_SATSolver "0.1.0.0"
#endif /* VERSION_SATSolver */
#ifndef MIN_VERSION_SATSolver
#define MIN_VERSION_SATSolver(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_SATSolver */
...
#define CURRENT_COMPONENT_ID "SATSolver-0.1.0.0-FZgpoueOc8WAWgTqxccqtb-SATSolver-test"
